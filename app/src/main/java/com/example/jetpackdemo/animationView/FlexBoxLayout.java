...
public class FlexBoxLayout extends LinearLayout {
    ...
    public FlexBoxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            horizontalSpace = array.getDimensionPixelOffset(
                    R.styleable.FlexBoxLayout_horizontalSpacing, 0);
            verticalSpace = array.getDimensionPixelOffset(
                    R.styleable.FlexBoxLayout_verticalSpacing, 0);
            array.recycle();
