package com.example.jetpackdemo.pageturn.factory;

import android.content.Context;
import android.graphics.Bitmap;
import android.graphics.Canvas;

import com.example.jetpackdemo.pageturn.utils.BitmapUtils;
import com.example.jetpackdemo.pageturn.utils.ScreenUtils;
...
public class PicturesPageFactory extends PageFactory {
    ...
    private Bitmap getBitmapFromIds(int index) {
        return BitmapUtils.drawableToBitmap(
                context.getResources().getDrawable(picturesIds[index], null),
