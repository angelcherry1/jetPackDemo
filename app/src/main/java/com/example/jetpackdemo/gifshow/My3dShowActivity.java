...
public class My3dShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my3d_show);
        initView();
        initEvent();
        /*checkSupported();
        if (supportsEs2) {
    ...
    private void initEvent() {
        mTvGif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(My3dShowActivity.this, GifActivity.class);
        ...
        mTvStl.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(My3dShowActivity.this, STLActivity.class);
                startActivity(intent);
            }
        });
        ...
        mTvGoogle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(My3dShowActivity.this, GoogleActivity.class);
                startActivity(intent);
            }
        });
