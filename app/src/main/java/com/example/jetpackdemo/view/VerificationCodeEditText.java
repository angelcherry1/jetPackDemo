...
public class VerificationCodeEditText extends AppCompatEditText implements
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.uikit_verification_code_edit_text);
        mFigures = ta.getInteger(R.styleable.uikit_verification_code_edit_text_uikit_figures, 4);
        mVerCodeMargin = (int) ta.getDimension(R.styleable.uikit_verification_code_edit_text_uikit_ver_code_margin, 0);
        mBottomSelectedColor = ta.getColor(R.styleable.uikit_verification_code_edit_text_uikit_bottom_line_selected_color,
                getCurrentTextColor());
        mBottomNormalColor = ta.getColor(R.styleable.uikit_verification_code_edit_text_uikit_bottom_line_normal_color,
                getColor(android.R.color.darker_gray));
        mBottomLineHeight = ta.getDimension(R.styleable.uikit_verification_code_edit_text_uikit_bottom_line_height,
                SizeUtils.dip2px(getContext(), 5));
        mSelectedBackgroundColor = ta.getColor(R.styleable.uikit_verification_code_edit_text_uikit_selected_background_color,
                getColor(android.R.color.darker_gray));
        mCursorWidth = (int) ta.getDimension(R.styleable.uikit_verification_code_edit_text_uikit_cursor_width, SizeUtils.dip2px(getContext(), 1));
        mCursorColor = ta.getColor(R.styleable.uikit_verification_code_edit_text_uikit_cursor_color, getColor(android.R.color.darker_gray));
        mCursorDuration = ta.getInteger(R.styleable.uikit_verification_code_edit_text_uikit_cursor_duration, DEFAULT_CURSOR_DURATION);
        ta.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        mCurrentPosition = Objects.requireNonNull(getText()).length();
