...
import com.example.jetpackdemo.view.bean.Circle;
import com.example.jetpackdemo.view.bean.Particle;
...
public class BubbleView extends View {
    ...
    //两个圆连接的点
    private PointF startCircleA = new PointF();
    private PointF startCircleB = new PointF();
    private PointF endCircleC = new PointF();
    private PointF endCircleD = new PointF();
    //控制贝塞尔曲线的点
    private PointF quadControlE = new PointF();
    //圆心相距的距离
    ...
    public BubbleView(Context context, AttributeSet attrs) {
        ...
        text_size = ta.getDimension(R.styleable.BubbleView_text_size, SizeUtils.dip2px(getContext(), 15));
        ta.recycle();
        init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (width_mode == MeasureSpec.EXACTLY) {
            ...
            widthMeasureSpec = SizeUtils.dip2px(getContext(), 15);
        }
        ...
        if (height_mode == MeasureSpec.EXACTLY) {
            ...
            heightMeasureSpec = SizeUtils.dip2px(getContext(), 15);
        }
